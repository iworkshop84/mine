...
<div id="page">
    ...
    <div id="posts">
        ...
        <form id="edit-server" action="/Users/Sedit/<?= $items->id ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="servereditfield"><input class="setextfield" type="text" id="description" name="description" value="<?= $items->description ?>"></div>
            <div class="clear"></div>
            ...
            <div class="editservertextblock">
                ...
                <span class="estext">
                    Ссылка на группу ВКонтакте вашего сервера.
                </span>
            </div>
